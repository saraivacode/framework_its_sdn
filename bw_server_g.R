...
tt<-c(taxabps1segcar0_g$size[1:195], taxabps1segcar1_g$size[1:195], taxabps1segcar2_g$size[1:195], taxabps1segcar3_g$size[1:195])
ttm<-c(taxabps1segcar0_g$size[1:195] + taxabps1segcar1_g$size[1:195] + taxabps1segcar2_g$size[1:195] + taxabps1segcar3_g$size[1:195])/4
...
tt<-c(taxabps1segserver_g_car0$size[1:195], taxabps1segserver_g_car1$size[1:195], taxabps1segserver_g_car2$size[1:195], taxabps1segserver_g_car3$size[1:195])
ttm<-c(taxabps1segserver_g_car0$size[1:195] + taxabps1segserver_g_car1$size[1:195] + taxabps1segserver_g_car2$size[1:195] + taxabps1segserver_g_car3$size[1:195])/4
tttime<-c(ttime, ttime, ttime, ttime)
