...
# mean1segserver_e_fn$size[1:157]<- mean1segserver_e_fn$size[1:157]/7
# mean1segserver_e_fn$size[158:235]<- mean1segserver_e_fn$size[158:235]/11
# mean1segserver_e_fn$size[236:300]<- mean1segserver_e_fn$size[236:300]/15
...
# mean1segcar_e_fn$size[1:157]<- mean1segcar_e_fn$size[1:157]/7
# mean1segcar_e_fn$size[158:235]<- mean1segcar_e_fn$size[158:235]/11
# mean1segcar_e_fn$size[236:300]<- mean1segcar_e_fn$size[236:300]/15
...
# boxplot(pdr75seg_e_fn[1:4], yaxt="n")
...
# mean1segdelay_e_fn$size[1:157]<- mean1segdelay_e_fn$size[1:157]/7
# mean1segdelay_e_fn$size[158:235]<- mean1segdelay_e_fn$size[158:235]/11
# mean1segdelay_e_fn$size[236:300]<- mean1segdelay_e_fn$size[236:300]/15
...
require(Rmisc)
w<-CI(pdr1seg_e_fn[1:75], ci=0.95)
x<-CI(pdr1seg_e_fn[76:150], ci=0.95)
y<-CI(pdr1seg_e_fn[151:225], ci=0.95)
z<-CI(pdr1seg_e_fn[225:300], ci=0.95)
...
plotCI(c(1:4), pdr75seg_e_fn[1:4], ui=up, li=lo, col="red", main="PDR Application E", ylab = "PDR", xlab = "time(s)", lwd="2" )
lines(c(1:4),pdr75seg_e_fn[1:4], type = "l", col="red", lwd="2")
...
tracecar_g_fn<-read.table(file = 'result/cartf_fn_5003_tt.txt', sep=' ')
...
# boxplot(pdr75seg_g_fn[1:4], yaxt="n")
# axis(2, xaxp=c(0.5, 1.3, 10))
...
par(new=T)
plot(mean1segdelay_g_fn$time[1:300], mean1segdelay_g_fn$size[1:300], type="l", col="orange", lwd=2, xlim = c(0,300), axes=F, xlab=NA, ylab=NA, ylim = c(0,100000))
axis(side = 4)
mtext(side = 4, line = 3, 'Delay (ms)')
legend("topleft", legend=c("Server received", "Car Sent", "Delay"), lty=c(1,1,1), col=c("blue", "red", "orange"))
...
require(Rmisc)
w<-CI(pdr1seg_g_fn[1:75], ci=0.95)
x<-CI(pdr1seg_g_fn[76:150], ci=0.95)
y<-CI(pdr1seg_g_fn[151:225], ci=0.95)
z<-CI(pdr1seg_g_fn[225:300], ci=0.95)
...
plotCI(c(1:4), pdr75seg_g_fn[1:4], ui=up, li=lo, col="red", main="PDR Application G", ylab = "PDR", xlab = "time(s)", lwd="2" )
lines(c(1:4),pdr75seg_g_fn[1:4], type = "l", col="red", lwd="2")
...
tracecar_e2_fn<-read.table(file = 'result/cartf_fn_5003_tt.txt', sep=' ')
...
# boxplot(pdr75seg_e2_fn[1:4], yaxt="n")
# axis(2, xaxp=c(0.5, 1.3, 10))
...
require(Rmisc)
w<-CI(pdr1seg_e2_fn[1:75], ci=0.95)
x<-CI(pdr1seg_e2_fn[76:150], ci=0.95)
y<-CI(pdr1seg_e2_fn[151:225], ci=0.95)
z<-CI(pdr1seg_e2_fn[225:300], ci=0.95)
...
plotCI(c(1:4), pdr75seg_e2_fn[1:4], ui=up, li=lo, col="red", main="PDR Application E2", ylab = "PDR", xlab = "time(s)", lwd="2" )
lines(c(1:4),pdr75seg_e2_fn[1:4], type = "l", col="red", lwd="2")
...
tracecar_s_fn<-read.table(file = 'result/cartf_fn_5003_tt.txt', sep=' ')
...
# boxplot(pdr75seg_s_fn[1:4], yaxt="n")
# axis(2, xaxp=c(0.5, 1.3, 10))
...
#Plot
par(mar = c(5,5,2,5))
plot(mean1segserver_s_fn$time[1:300], mean1segserver_s_fn$size[1:300], type="l", col="blue", main = "Application S (fn)", lwd=2, xlim = c(1,300), ylab="Throughput (bps)", ylim = c(0,900000), xlab = "time(s)")
lines(mean1segcar_s_fn$time[1:300], mean1segcar_s_fn$size[1:300], col="red", lwd=2, ylim = c(0,900000))
par(new=T)
...
require(Rmisc)
w<-CI(pdr1seg_s_fn[1:75], ci=0.95)
x<-CI(pdr1seg_s_fn[76:150], ci=0.95)
y<-CI(pdr1seg_s_fn[151:225], ci=0.95)
z<-CI(pdr1seg_s_fn[225:300], ci=0.95)
...
plotCI(c(1:4), pdr75seg_s_fn[1:4], ui=up, li=lo, col="red", main="PDR Application S", ylab = "PDR", xlab = "time(s)", lwd="2" )
lines(c(1:4),pdr75seg_s_fn[1:4], type = "l", col="red", lwd="2")
