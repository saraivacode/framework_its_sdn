...
par(new = T)
plotCI(dtime_e[2:300], delaymean_e[2:300], ui=y3$delaytotal_e.upper[2:300], li=y3$delaytotal_e.lower[2:300], col="orange", axes=F, xlab=NA, ylab=NA, ylim = range(0:50))
...
ptime_g<-c(0:299)
PDRtotal_g<- c(taxabps1segserver_g_car0$size[1:300]/taxabps1segcar0_g$size[1:300], taxabps1segserver_g_car1$size[1:300]/taxabps1segcar1_g$size[1:300], taxabps1segserver_g_car2$size[1:300]/taxabps1segcar2_g$size[1:300], taxabps1segserver_g_car3$size[1:300]/taxabps1segcar3_g$size[1:300], taxabps1segserver_g_car4$size[1:300]/taxabps1segcar4_g$size[1:300], taxabps1segserver_g_car5$size[1:300]/taxabps1segcar5_g$size[1:300], taxabps1segserver_g_car6$size[1:300]/taxabps1segcar6_g$size[1:300])
PDRmean_g<-c(taxabps1segserver_g_car0$size[1:300]/taxabps1segcar0_g$size[1:300] + taxabps1segserver_g_car1$size[1:300]/taxabps1segcar1_g$size[1:300] + taxabps1segserver_g_car2$size[1:300]/taxabps1segcar2_g$size[1:300] + taxabps1segserver_g_car3$size[1:300]/taxabps1segcar3_g$size[1:300] + taxabps1segserver_g_car4$size[1:300]/taxabps1segcar4_g$size[1:300] + taxabps1segserver_g_car5$size[1:300]/taxabps1segcar5_g$size[1:300] + taxabps1segserver_g_car6$size[1:300]/taxabps1segcar6_g$size[1:300])/7
fptime_g<-c(ptime_g, ptime_g, ptime_g, ptime_g, ptime_g, ptime_g, ptime_g) 
...
plotCI(ptime_s, PDRmean_s, ui=y4$PDRtotal_s.upper, li=y4$PDRtotal_s.lower, col="red", main="PDR E2", ylab = "PDR mean (%)", xlab = "time(s)")
