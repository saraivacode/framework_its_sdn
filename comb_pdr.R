...
mean1segcar_e_fq$transmissores <- xs$transmissores
...
mean1segserver_e_fq$transmissores <- xs$transmissores
...
mean1segcar_e_fn$transmissores <- xs$transmissores
...
mean1segserver_e_fn$transmissores <- xs$transmissores
...
#plotCI(c(1:4), pdr75seg_e_fs[1:4], ui=up_e_fs, li=lo_e_fs, col="red", main="PDR Application E", ylab = "PDR", xlab = "Time slot", lwd="2", ylim=c(0.5,1), xaxt="n")
plotCI(c(1:4), pdr75seg_e_fs[1:4], ui=up_e_fs, li=lo_e_fs, col="red", ylab = "PDR", xlab = "Time slot", lwd="2", ylim=c(0.4,1), xaxt="n", , cex.axis=1.5, cex.lab=1.5)
axis(1, at=1:4, labels=c("T1", "T2", "T3", "T4"), cex.axis=1.5)
lines(c(1:4),pdr75seg_e_fs[1:4], type = "l", col="red", lwd="2", lty=2)
par(new=T)
plotCI(c(1:4), pdr75seg_e_fq[1:4], ui=up_e_fq, li=lo_e_fq, col="blue", axes=F, xlab=NA, ylab=NA, lwd="2", ylim=c(0.4,1))
lines(c(1:4),pdr75seg_e_fq[1:4], type = "l", col="blue", lwd="2", lty=3)
par(new=T)
plotCI(c(1:4), pdr75seg_e_fn[1:4], ui=up_e_fn, li=lo_e_fn, col="orange", axes=F, xlab=NA, ylab=NA, lwd="2", ylim=c(0.4,1))
lines(c(1:4),pdr75seg_e_fn[1:4], type = "l", col="orange", lwd="2", lty=6)
legend("topright", legend=c("Framework", "QoS", "Best effort"), lty=c(2,3,6), col=c("red", "blue", "orange"), cex=1.3)
...
#plotCI(c(1:4), pdr75seg_e2_fs[1:4], ui=up_e2_fs, li=lo_e2_fs, col="red", main="PDR Application E2", ylab = "PDR", xlab = "Time slot", lwd="2", ylim=c(0.5,1),  xaxt="n")
plotCI(c(1:4), pdr75seg_e2_fs[1:4], ui=up_e2_fs, li=lo_e2_fs, col="red", ylab = "PDR", xlab = "Time slot", lwd="2", ylim=c(0,1),  xaxt="n", cex.axis=1.5, cex.lab=1.5)
axis(1, at=1:4, labels=c("T1", "T2", "T3", "T4"), cex.axis=1.5)
lines(c(1:4),pdr75seg_e2_fs[1:4], type = "l", col="red", lwd="2", lty=2)
par(new=T)
plotCI(c(1:4), pdr75seg_e2_fq[1:4], ui=up_e2_fq, li=lo_e2_fq, col="blue", axes=F, xlab=NA, ylab=NA, lwd="2", ylim=c(0,1))
lines(c(1:4),pdr75seg_e2_fq[1:4], type = "l", col="blue", lwd="2", lty=3)
par(new=T)
plotCI(c(1:4), pdr75seg_e2_fn[1:4], ui=up_e2_fn, li=lo_e2_fn, col="orange", axes=F, xlab=NA, ylab=NA, lwd="2", ylim=c(0,1))
lines(c(1:4),pdr75seg_e2_fn[1:4], type = "l", col="orange", lwd="2", lty=6)
legend("topright", legend=c("Framework", "QoS", "Best effort"), lty=c(2,3,6), col=c("red", "blue", "orange"), cex=1.3)
...
#plotCI(c(1:4), pdr75seg_g_fs[1:4], ui=up_g_fs, li=lo_g_fs, col="red", main="PDR Application G", ylab = "PDR", xlab = "Time slot", lwd="2" , ylim=c(0,1), xaxt="n")
plotCI(c(1:4), pdr75seg_g_fs[1:4], ui=up_g_fs, li=lo_g_fs, col="red", ylab = "PDR", xlab = "Time slot", lwd="2" , ylim=c(0,1), xaxt="n", cex.axis=1.5, cex.lab=1.5)
axis(1, at=1:4, labels=c("T1", "T2", "T3", "T4"), cex.axis=1.5)
lines(c(1:4),pdr75seg_g_fs[1:4], type = "l", col="red", lwd="2", lty=2)
par(new=T)
plotCI(c(1:4), pdr75seg_g_fq[1:4], ui=up_g_fq, li=lo_g_fq, col="blue", axes=F, xlab=NA, ylab=NA, lwd="2", ylim=c(0,1))
lines(c(1:4),pdr75seg_g_fq[1:4], type = "l", col="blue", lwd="2", lty=3)
par(new=T)
plotCI(c(1:4), pdr75seg_g_fn[1:4], ui=up_g_fn, li=lo_g_fn, col="orange", axes=F, xlab=NA, ylab=NA, lwd="2", ylim=c(0,1) )
lines(c(1:4),pdr75seg_g_fn[1:4], type = "l", col="orange", lwd="2", lty=6)
legend("topright", legend=c("Framework", "QoS", "Best effort"), lty=c(2,3,6), col=c("red", "blue", "orange"), cex=1.3)
...
#plotCI(c(1:4), pdr75seg_s_fs[1:4], ui=up_s_fs, li=lo_s_fs, col="red", main="PDR Application S", ylab = "PDR", xlab = "Time slot", lwd="2", ylim=c(0.6,1.05), xaxt="n")
plotCI(c(1:4), pdr75seg_s_fs[1:4], ui=up_s_fs, li=lo_s_fs, col="red", ylab = "PDR", xlab = "Time slot", lwd="2", ylim=c(0.4,1.05), xaxt="n", cex.axis=1.5, cex.lab=1.5)
axis(1, at=1:4, labels=c("T1", "T2", "T3", "T4"), cex.axis=1.5)
lines(c(1:4),pdr75seg_s_fs[1:4], type = "l", col="red", lwd="2", lty=2)
par(new=T)
plotCI(c(1:4), pdr75seg_s_fq[1:4], ui=up_s_fq, li=lo_s_fq, col="blue", axes=F, xlab=NA, ylab=NA, lwd="2", ylim=c(0.4,1.05))
lines(c(1:4),pdr75seg_s_fq[1:4], type = "l", col="blue", lwd="2", lty=3)
par(new=T)
plotCI(c(1:4), pdr75seg_s_fn[1:4], ui=up_s_fn, li=lo_s_fn, col="orange", axes=F, xlab=NA, ylab=NA, lwd="2", ylim=c(0.4,1.05))
lines(c(1:4),pdr75seg_s_fn[1:4], type = "l", col="orange", lwd="2", lty=6)
legend("topright", legend=c("Framework", "QoS", "Best effort"), lty=c(2,3,6), col=c("red", "blue", "orange"), cex=1.3)
