...
plotCI(c(1:4), pdr75seg_e_fs[1:4], ui=up_e_fs, li=lo_e_fs, col="red", ylab = "PDR", xlab = "Time slot", lwd="2", ylim=c(0.5,1), xaxt="n", , cex.axis=1.5, cex.lab=1.5)
...
plotCI(c(1:4), pdr75seg_e2_fs[1:4], ui=up_e2_fs, li=lo_e2_fs, col="red", ylab = "PDR", xlab = "Time slot", lwd="2", ylim=c(0.5,1),  xaxt="n", cex.axis=1.5, cex.lab=1.5)
axis(1, at=1:4, labels=c("T1", "T2", "T3", "T4"), cex.axis=1.5)
...
plotCI(c(1:4), pdr75seg_s_fs[1:4], ui=up_s_fs, li=lo_s_fs, col="red", ylab = "PDR", xlab = "Time slot", lwd="2", ylim=c(0.6,1.05), xaxt="n", cex.axis=1.5, cex.lab=1.5)
axis(1, at=1:4, labels=c("T1", "T2", "T3", "T4"), cex.axis=1.5)
