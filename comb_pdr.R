...
plotCI(c(1:4), pdr75seg_e_fs[1:4], ui=up_e_fs, li=lo_e_fs, col="red", ylab = "PDR", xlab = "Time slot", lwd="2", ylim=c(0.5,1), xaxt="n")
...
legend("topright", legend=c("Framework", "QoS", "Best effort"), lty=c(2,3,6), col=c("red", "blue", "orange"))
...
plotCI(c(1:4), pdr75seg_e2_fs[1:4], ui=up_e2_fs, li=lo_e2_fs, col="red", ylab = "PDR", xlab = "Time slot", lwd="2", ylim=c(0.5,1),  xaxt="n")
axis(1, at=1:4, labels=c("T1", "T2", "T3", "T4"))
...
plotCI(c(1:4), pdr75seg_g_fs[1:4], ui=up_g_fs, li=lo_g_fs, col="red", ylab = "PDR", xlab = "Time slot", lwd="2" , ylim=c(0,1), xaxt="n")
axis(1, at=1:4, labels=c("T1", "T2", "T3", "T4"))
...
plotCI(c(1:4), pdr75seg_s_fs[1:4], ui=up_s_fs, li=lo_s_fs, col="red", ylab = "PDR", xlab = "Time slot", lwd="2", ylim=c(0.6,1.05), xaxt="n")
axis(1, at=1:4, labels=c("T1", "T2", "T3", "T4"))
