...
mean1segserver_e_fs<-append(list(size = sum1segserver_e_fs$size/7), list(time = sum1segserver_e_fs$segundos))
mean1segserver_e_fs$time <- as.numeric(mean1segserver_e_fs$time)
...
mean1segcar_e_fs<-append(list(size = sum1segcar_e_fs$size/7), list(time = sum1segcar_e_fs$segundos))
mean1segcar_e_fs$time <- as.numeric(mean1segcar_e_fs$time)
...
mean1segdelay_e_fs<-append(list(size = sum1segdelay_e_fs$delay/7), list(time = sum1segdelay_e_fs$segundos))
mean1segdelay_e_fs$time <- as.numeric(mean1segdelay_e_fs$time)

#Plot
par(mar = c(5,5,2,5))
plot(mean1segserver_e_fs$time, mean1segserver_e_fs$size, type="l", col="blue", main = "Server E (FS)", lwd=2, xlim = c(0,300), ylab="Throughput (bps)", ylim = c(0,700000))
lines(mean1segcar_e_fs$time, mean1segcar_e_fs$size, col="red", lwd=2)
par(new=T)
plot(mean1segdelay_e_fs$time, mean1segdelay_e_fs$size, type="l", col="orange", lwd=2, xlim = c(0,300), axes=F, xlab=NA, ylab=NA, ylim = c(0,2000))
axis(side = 4)
...
plot(mean1segserver_e_fs$time, pdr1seg_e_fs, type="l", col="blue", main = "Server E PDR (FS)", lwd=2, xlim = c(0,300), ylab="PDR", ylim = c(0,1.2))
...
#Plot
par(mar = c(5,5,2,5))
plot(mean1segserver_g_fs$time, mean1segserver_g_fs$size, type="l", col="blue", main = "Server G (FS)", lwd=2, xlim = c(0,300), ylab="Throughput (bps)", ylim = c(0,700000))
...
plot(mean1segserver_g_fs$time[1:300], pdr1seg_g_fs, type="l", col="blue", main = "Server G PDR (FS)", lwd=2, xlim = c(0,300), ylab="PDR", ylim = c(0,1.2))
...
#Plot
par(mar = c(5,5,2,5))
plot(mean1segserver_e2_fs$time, mean1segserver_e2_fs$size, type="l", col="blue", main = "Server E2 (FS)", lwd=2, xlim = c(0,300), ylab="Throughput (bps)", ylim = c(0,1500000))
...
plot(mean1segserver_e2_fs$time[1:300], pdr1seg_e2_fs, type="l", col="blue", main = "Server E2 PDR (FS)", lwd=2, xlim = c(0,300), ylab="PDR", ylim = c(0,1.2))
...
#Plot
par(mar = c(5,5,2,5))
plot(mean1segserver_s_fs$time, mean1segserver_s_fs$size, type="l", col="blue", main = "Server S (FS)", lwd=2, xlim = c(0,300), ylab="Throughput (bps)", ylim = c(0,1000000))
...
plot(mean1segserver_s_fs$time[1:300], pdr1seg_s_fs, type="l", col="blue", main = "Server S PDR (FS)", lwd=2, xlim = c(0,300), ylab="PDR", ylim = c(0,1.2))
