...
#Plot
par(mar = c(5,5,2,5))
plot(mean1segserver_e_fs$time[1:300], mean1segserver_e_fs$size[1:300], type="l", col="blue", main = "Server E (FS)", lwd=2, xlim = c(0,300), ylab="Throughput (bps)", ylim = c(0,650000), xlab = "time(s)")
lines(mean1segcar_e_fs$time[1:300], mean1segcar_e_fs$size[1:300], col="red", lwd=2, ylim = c(0,650000))
par(new=T)
plot(mean1segdelay_e_fs$time[1:300], mean1segdelay_e_fs$size[1:300], type="l", col="orange", lwd=2, xlim = c(0,300), axes=F, xlab=NA, ylab=NA, ylim = c(0,4000))
axis(side = 4)
...
plot(mean1segserver_e_fs$time[1:300], pdr1seg_e_fs[1:300], type="l", col="blue", main = "Server E PDR (FS)", lwd=2, xlim = c(0,300), ylab="PDR", ylim = c(0,1.65), xlab = "time(s)")

boxplot(pdr1seg_e_fs[1:300], ylim = c(0.3,1.5), main = "Server E PDR (FS)", lwd=2, ylab="PDR")
...
#Plot
par(mar = c(5,5,2,5))
plot(mean1segserver_g_fs$time[1:300], mean1segserver_g_fs$size[1:300], type="l", col="blue", main = "Server G (FS)", lwd=2, xlim = c(0,300), ylab="Throughput (bps)", ylim = c(0,650000), xlab = "time(s)")
lines(mean1segcar_g_fs$time[1:300], mean1segcar_g_fs$size[1:300], col="red", lwd=2, ylim = c(0,650000))
par(new=T)
plot(mean1segdelay_g_fs$time[1:300], mean1segdelay_g_fs$size[1:300], type="l", col="orange", lwd=2, xlim = c(0,300), axes=F, xlab=NA, ylab=NA, ylim = c(0,50000))
axis(side = 4)
mtext(side = 4, line = 3, 'Delay (ms)')
legend("topleft", legend=c("Server received", "Car Sent", "Delay"), lty=c(1,1,1), col=c("blue", "red", "orange"))
...
plot(mean1segserver_g_fs$time[1:300], pdr1seg_g_fs, type="l", col="blue", main = "Server G PDR (FS)", lwd=2, xlim = c(0,300), ylab="PDR", ylim = c(0,1.4), xlab = "time(s)")

boxplot(pdr1seg_g_fs[1:300], ylim = c(0,0.8),main = "Server G PDR (FS)", lwd=2, ylab="PDR")
...
#Plot
par(mar = c(5,5,2,5))
plot(mean1segserver_e2_fs$time[1:300], mean1segserver_e2_fs$size[1:300], type="l", col="blue", main = "Server E2 (FS)", lwd=2, xlim = c(0,300), ylab="Throughput (bps)", ylim = c(0,1300000), xlab = "time(s)")
lines(mean1segcar_e2_fs$time[1:300], mean1segcar_e2_fs$size[1:300], col="red", lwd=2, ylim = c(0,1300000))
par(new=T)
plot(mean1segdelay_e2_fs$time[1:300], mean1segdelay_e2_fs$size[1:300], type="l", col="orange", lwd=2, xlim = c(0,300), axes=F, xlab=NA, ylab=NA, ylim = c(0,4000))
axis(side = 4)
mtext(side = 4, line = 3, 'Delay (ms)')
legend("topleft", legend=c("Server received", "Car Sent", "Delay"), lty=c(1,1,1), col=c("blue", "red", "orange"))
...
plot(mean1segserver_e2_fs$time[1:300], pdr1seg_e2_fs, type="l", col="blue", main = "Server E2 PDR (FS)", lwd=2, xlim = c(0,300), ylab="PDR", ylim = c(0,1.4), xlab = "time(s)")

boxplot(pdr1seg_e2_fs[1:300], main = "Server E2 PDR (FS)", lwd=2, ylab="PDR", ylim = c(0,1.5))
...
#Plot
par(mar = c(5,5,2,5))
plot(mean1segserver_s_fs$time[1:300], mean1segserver_s_fs$size[1:300], type="l", col="blue", main = "Server S (FS)", lwd=2, xlim = c(0,300), ylab="Throughput (bps)", ylim = c(0,750000), xlab = "time(s)")
lines(mean1segcar_s_fs$time[1:300], mean1segcar_s_fs$size[1:300], col="red", lwd=2,  ylim = c(0,750000))
par(new=T)
...
plot(mean1segserver_s_fs$time[1:300], pdr1seg_s_fs, type="l", col="blue", main = "Server S PDR (FS)", lwd=2, xlim = c(0,300), ylab="PDR", ylim = c(0,2.0), xlab = "time(s)")

boxplot(pdr1seg_s_fs[1:300], main = "Server S PDR (FS)", lwd=2, ylab="PDR", ylim = c(0.3,1.3))
