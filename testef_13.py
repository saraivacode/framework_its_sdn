...
def topology():
   ...
   # for x in xrange(0,15):
        ...
        #cars[x].cmdPrint("hping3 --udp -p 5002 -c 1 -d 1470 200.0.10.2 -q &")
        
        #cars[x].cmdPrint("hping3 --udp -p 5003 -c 1 -d 1470 200.0.10.3 -q &")
 
        #cars[x].cmdPrint("hping3 --udp -p 5004 -c 1 -d 1470 200.0.10.4 -q &")
