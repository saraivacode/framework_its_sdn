...
plot(ecdf(mean1segdelay_e2_fs$size), col.01line = "gray70", pch = 19, col="red", xlim = c(0,2000), ylim = c(0,1), main="CDF Delay Application E2", ylab = "CDF", xlab = "delay")
abline( h= 0.8, lty =3, col = "gray60")
par(new=T)
...
plot(ecdf(mean1segdelay_g_fs$size), col.01line = "gray70", pch = 19, col="red", ylim = c(0,1), xlim = c(0,15000), main="CDF Delay Application G", ylab = "CDF", xlab = "delay")
abline( h= 0.8, lty =3, col = "gray60")
par(new=T)
...
plot(ecdf(mean1segdelay_s_fs$size), col.01line = "gray70", pch = 19, col="red", xlim = c(0,300), ylim = c(0,1), main="CDF Delay Application S", ylab = "CDF", xlab = "delay")
abline( h= 0.8, lty =3, col = "gray60")
par(new=T)
