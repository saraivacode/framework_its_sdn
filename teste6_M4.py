...
def topology():
    ...
    cars[0] = net.addCar('car0',  wlans=2, range='50,50', ip='200.0.10.110/8', mac='00:00:00:00:00:01', position='1105,975,0')
    cars[1] = net.addCar('car1',  wlans=2, range='50,50', ip='200.0.10.111/8', mac='00:00:00:00:00:02', position='1110,975,0')
    cars[2] = net.addCar('car2',  wlans=2, range='50,50', ip='200.0.10.112/8', mac='00:00:00:00:00:03', position='1605,975,0')
    cars[3] = net.addCar('car3',  wlans=2, range='50,50', ip='200.0.10.113/8', mac='00:00:00:00:00:04', position='2105,975,0')
    cars[4] = net.addCar('car4',  wlans=2, range='50,50', ip='200.0.10.114/8', mac='00:00:00:00:00:05', position='2100,975,0')
    cars[5] = net.addCar('car5',  wlans=2, range='50,50', ip='200.0.10.115/8', mac='00:00:00:00:00:06', position='2110,975,0')
    cars[6] = net.addCar('car6',  wlans=2, range='50,50', ip='200.0.10.116/8', mac='00:00:00:00:00:07', position='2095,975,0')

    cars[7] = net.addCar('car7',  wlans=2, range='50,50', ip='200.0.10.117/8', mac='00:00:00:00:00:08', position='1560,975,0')
    cars[8] = net.addCar('car8',  wlans=2, range='50,50', ip='200.0.10.118/8', mac='00:00:00:00:00:09', position='1570,975,0')
    cars[9] = net.addCar('car9',  wlans=2, range='50,50', ip='200.0.10.119/8', mac='00:00:00:00:00:10', position='1580,975,0')
    cars[10] = net.addCar('car10',  wlans=2, range='50,50', ip='200.0.10.120/8', mac='00:00:00:00:00:11', position='1590,975,0')
    cars[11] = net.addCar('car11',  wlans=2, range='50,50', ip='200.0.10.121/8', mac='00:00:00:00:00:12', position='1600,975,0')
    cars[12] = net.addCar('car12',  wlans=2, range='50,50', ip='200.0.10.122/8', mac='00:00:00:00:00:13', position='1585,975,0')

    cars[13] = net.addCar('car13',  wlans=2, range='50,50', ip='200.0.10.123/8', mac='00:00:00:00:00:14', position='1060,975,0')
    cars[14] = net.addCar('car14',  wlans=2, range='50,50', ip='200.0.10.124/8', mac='00:00:00:00:00:15', position='1070,975,0')
    cars[15] = net.addCar('car15',  wlans=2, range='50,50', ip='200.0.10.125/8', mac='00:00:00:00:00:16', position='1080,975,0')
    cars[16] = net.addCar('car16',  wlans=2, range='50,50', ip='200.0.10.126/8', mac='00:00:00:00:00:17', position='1090,975,0')
    cars[17] = net.addCar('car17',  wlans=2, range='50,50', ip='200.0.10.127/8', mac='00:00:00:00:00:18', position='1100,975,0')
    cars[18] = net.addCar('car18',  wlans=2, range='50,50', ip='200.0.10.128/8', mac='00:00:00:00:00:19', position='1110,975,0')
    cars[19] = net.addCar('car19',  wlans=2, range='50,50', ip='200.0.10.129/8', mac='00:00:00:00:00:20', position='1120,975,0')

    cars[20] = net.addCar('car20',  wlans=2, range='50,50', ip='200.0.10.130/8', mac='00:00:00:00:00:21', position='20,1025,0')
    cars[21] = net.addCar('car21',  wlans=2, range='50,50', ip='200.0.10.131/8', mac='00:00:00:00:00:22', position='40,1025,0')
    cars[22] = net.addCar('car22',  wlans=2, range='50,50', ip='200.0.10.132/8', mac='00:00:00:00:00:23', position='60,1025,0')
    cars[23] = net.addCar('car23',  wlans=2, range='50,50', ip='200.0.10.133/8', mac='00:00:00:00:00:24', position='80,1025,0')
    cars[24] = net.addCar('car24',  wlans=2, range='50,50', ip='200.0.10.134/8', mac='00:00:00:00:00:25', position='100,1025,0')
    cars[25] = net.addCar('car25',  wlans=2, range='50,50', ip='200.0.10.135/8', mac='00:00:00:00:00:26', position='120,1025,0')
    cars[26] = net.addCar('car26',  wlans=2, range='50,50', ip='200.0.10.136/8', mac='00:00:00:00:00:27', position='140,1025,0')
    cars[27] = net.addCar('car27',  wlans=2, range='50,50', ip='200.0.10.137/8', mac='00:00:00:00:00:28', position='160,1025,0')
    cars[28] = net.addCar('car28',  wlans=2, range='50,50', ip='200.0.10.138/8', mac='00:00:00:00:00:29', position='180,1025,0')
    cars[29] = net.addCar('car29',  wlans=2, range='50,50', ip='200.0.10.139/8', mac='00:00:00:00:00:30', position='200,1025,0')

    # cars[30] = net.addCar('car30',  wlans=2, range='50,50', ip='200.0.10.140/8', mac='00:00:00:00:00:31', position='210,1025,0')
    # cars[31] = net.addCar('car31',  wlans=2, range='50,50', ip='200.0.10.141/8', mac='00:00:00:00:00:32', position='220,1025,0')
    # cars[32] = net.addCar('car32',  wlans=2, range='50,50', ip='200.0.10.142/8', mac='00:00:00:00:00:33', position='240,1025,0')
    # cars[33] = net.addCar('car33',  wlans=2, range='50,50', ip='200.0.10.143/8', mac='00:00:00:00:00:34', position='260,1025,0')
    # cars[34] = net.addCar('car34',  wlans=2, range='50,50', ip='200.0.10.144/8', mac='00:00:00:00:00:35', position='280,1025,0')
    # cars[35] = net.addCar('car35',  wlans=2, range='50,50', ip='200.0.10.145/8', mac='00:00:00:00:00:36', position='300,1025,0')
    # cars[36] = net.addCar('car36',  wlans=2, range='50,50', ip='200.0.10.146/8', mac='00:00:00:00:00:37', position='320,1025,0')
    # cars[37] = net.addCar('car37',  wlans=2, range='50,50', ip='200.0.10.147/8', mac='00:00:00:00:00:38', position='340,1025,0')
    # cars[38] = net.addCar('car38',  wlans=2, range='50,50', ip='200.0.10.148/8', mac='00:00:00:00:00:39', position='360,1025,0')
    # cars[39] = net.addCar('car39',  wlans=2, range='50,50', ip='200.0.10.149/8', mac='00:00:00:00:00:40', position='380,1025,0')
    ...
    rsu1 = net.addAccessPoint('rsu1', ssid='rsu1', channel='11',range=250, position='1100,1000,0', protocols='OpenFlow13')
    rsu2 = net.addAccessPoint('rsu2', ssid='rsu2', channel='11', range=250, position='1600,1000,0', protocols='OpenFlow13')
    rsu3 = net.addAccessPoint('rsu3', ssid='rsu3', channel='11', range=250, position='2100,1000,0', protocols='OpenFlow13')
