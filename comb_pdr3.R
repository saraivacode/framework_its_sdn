...
pdr1seg_e_fs<-append(list(pdr = meanpd1segserver_e_fs$size[1:t]/meanpd1segcar_e_fs$size[1:t]), list(time = c(1:t)))
...
pdr1seg_e_fq<-append(list(pdr = meanpd1segserver_e_fq$size[1:t]/meanpd1segcar_e_fq$size[1:t]), list(time = c(1:t)))
...
pdr1seg_e_fn<-append(list(pdr = meanpd1segserver_e_fn$size[1:t]/meanpd1segcar_e_fn$size[1:t]), list(time = c(1:t)))
...
pdr1seg_e2_fs<-append(list(pdr = meanpd1segserver_e2_fs$size[1:t]/meanpd1segcar_e2_fs$size[1:t]), list(time = c(1:t)))
...
pdr1seg_e2_fq<-append(list(pdr = meanpd1segserver_e2_fq$size[1:t]/meanpd1segcar_e2_fq$size[1:t]), list(time = c(1:t)))
...
pdr1seg_e2_fn<-append(list(pdr = meanpd1segserver_e2_fn$size[1:t]/meanpd1segcar_e2_fn$size[1:t]), list(time = c(1:t)))
...
pdr1seg_g_fs<-append(list(pdr = meanpd1segserver_g_fs$size[1:t]/meanpd1segcar_g_fs$size[1:t]), list(time = c(1:t)))
...
pdr1seg_g_fq<-append(list(pdr = meanpd1segserver_g_fq$size[1:t]/meanpd1segcar_g_fq$size[1:t]), list(time = c(1:t)))
...
pdr1seg_g_fn<-append(list(pdr = meanpd1segserver_g_fn$size[1:t]/meanpd1segcar_g_fn$size[1:t]), list(time = c(1:t)))
...
pdr1seg_s_fs<-append(list(pdr = meanpd1segserver_s_fs$size[1:t]/meanpd1segcar_s_fs$size[1:t]), list(time = c(1:t)))
...
pdr1seg_s_fq<-append(list(pdr = meanpd1segserver_s_fq$size[1:t]/meanpd1segcar_s_fq$size[1:t]), list(time = c(1:t)))
...
pdr1seg_s_fn<-append(list(pdr = meanpd1segserver_s_fn$size[1:t]/meanpd1segcar_s_fn$size[1:t]), list(time = c(1:t)))
...
legenda <- c("RMSDVN", "Framework", "QoS Only")
...
ggplot(e_app, aes(x=tipo, y=pdr, fill='#56B4E9')) +
  ...
  scale_x_discrete(labels= legenda) +
  theme_bw() + theme(
